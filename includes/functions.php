...
function getSampleProducts($limit = null) {
    $products = [
        ...
        [
            'id' => 17,
            'name' => 'Butterfly Pearl Glow 🦋',
            'short_description' => 'Timeless chain bracelet with delicate links',
            'description' => 'A delicate beaded bracelet with pink and blue glass beads, adorned with a pearl charm and a cute pink butterfly.',
            'price' => 250,
        ...
        [
            'id' => 18,
            'name' => 'Blush Pearl Butterfly Bracelet 🌷',
            'short_description' => 'Timeless chain bracelet with delicate links',
            'description' => 'Elegant pink beaded bracelet with a lustrous pearl charm and a dainty pink butterfly pendant for a soft, feminine touch.',
            'price' => 200,
        ...
        [
            ...
            'name' => 'Black Beauty 🖤',
            'short_description' => 'Personalizable charm bracelet with multiple charms',
            'description' => 'Elegant and timeless, this pure black bracelet adds a touch of sophistication to any style. Perfect for everyday wear and for adding a bold touch to your outfit',
            'price' => 100,
        ...
        [
            'id' => 20,
            'name' => 'Panda Promise- Best Friends Bracelet Set ✨🐼',
            'short_description' => 'A perfect gift for you & your friend',
            'description' => 'Matching bracelets with cute panda charms and crackled beads, symbolizing the special bond between best friends. Stay connected, no matter the distance.',
            'price' => 500,
        ...
        [
            'id' => 21,
            'name' => 'Custom Name Keychains ✨',
            'short_description' => 'A perfect gift for you.',
            'description' => ' You can customise Keychains on the design you want with your custom colours .',
            'price' => 150,
        ...
        [
            'id' => 22,
            'name' => '6Packs Mystery scoop',
            'short_description' => 'A Delightly and Cute Mystery',
            'description' => 'You can win more just by a bead found in your pack of bracelet . Win exciting mystery bracelets with us . ✨💐',
            'price' => 1200,
...
function getProductAdditionalImages($productId) {
    $imageMap = [
        ...
        17 => ['assets/images/13.jpg', 'assets/images/13.1.jpg'],
        18 => ['assets/images/12.1.jpg', 'assets/images/12.jpg'],
        19 => ['assets/images/14.1.jpg', 'assets/images/14.jpg'],
        20 => ['assets/images/20.1.jpg', 'assets/images/20.jpg'],
        21 => ['assets/images/21.1.jpg', 'assets/images/21.jpg']
    ];
